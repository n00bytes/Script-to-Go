...
###
nmap -T4 -Pn -n -sS -A --open --top-ports 10000 --max-rate 5000 --defeat-rst-ratelimit -iL $TargetFile -oA "$outNmap"/Nmap-TCP-10K &>/dev/null
echo -e "${BGreen}Port Scanning Top-ports 10000 TCP........${BRed}[DONE]"
###
nmap -T4 -Pn -n -sU -A --open --top-ports 1000 --max-rate 5000 -iL $TargetFile -oA "$outNmap"/Nmap-UDP-1K &>/dev/null
